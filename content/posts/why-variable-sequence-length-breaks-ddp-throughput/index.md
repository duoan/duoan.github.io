...
I used a small synthetic lab from the companion `playground-cuda` repo and bundled the generated artifacts here with the post.
...
- structured summaries: [results.json](./results.json)
- charts:
  - [strategy_step_time.svg](./strategy_step_time.svg)
  - [strategy_useful_tokens_per_s.svg](./strategy_useful_tokens_per_s.svg)
  - [strategy_padding_ratio.svg](./strategy_padding_ratio.svg)
  - [strategy_token_spread.svg](./strategy_token_spread.svg)
  - [sample_vs_token_rank_work.svg](./sample_vs_token_rank_work.svg)
- raw logs:
  - [fixed_sample_ws4.log](./fixed_sample_ws4.log)
  - [variable_sample_ws4.log](./variable_sample_ws4.log)
  - [variable_bucket_ws4.log](./variable_bucket_ws4.log)
  - [variable_token_ws4.log](./variable_token_ws4.log)
...
These are the steady-state results from [timings.csv](./timings.csv).
...
![Variable-Length Transformer: Slowest Step Time](./strategy_step_time.svg)

And the throughput view:

![Variable-Length Transformer: Useful Token Throughput](./strategy_useful_tokens_per_s.svg)
...
![Variable-Length Transformer: Average Padding Ratio](./strategy_padding_ratio.svg)
...
![Variable-Length Transformer: Average Rank Token Spread](./strategy_token_spread.svg)
...
![Per-Rank Useful Tokens vs Padding Waste](./sample_vs_token_rank_work.svg)

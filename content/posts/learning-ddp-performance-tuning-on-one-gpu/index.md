...
- raw logs:
  - [weak_ws1.log](./weak_ws1.log)
  - [weak_ws2.log](./weak_ws2.log)
  - [weak_ws4.log](./weak_ws4.log)
  - [strong_ws1.log](./strong_ws1.log)
  - [strong_ws2.log](./strong_ws2.log)
  - [skew_ws4.log](./skew_ws4.log)
  - [comm_ws4.log](./comm_ws4.log)
  - [barrier_ws4.log](./barrier_ws4.log)
...
These are the headline numbers from [timings.csv](./timings.csv).
...
![Weak Scaling Throughput](./weak_scaling_throughput.svg)
...
![Strong Scaling Efficiency](./strong_scaling_efficiency.svg)
...
![Why One Slow Rank Hurts Everyone](./straggler_rank_breakdown.svg)
...
![Pathology Sweep: Slowest Step Time](./pathology_slowest_step.svg)

And here is the throughput view:

![Pathology Sweep: Global Throughput](./pathology_throughput.svg)
...
I wrote a separate experiment-driven follow-up focused entirely on this problem at [Why Variable Sequence Length Breaks DDP Throughput](/posts/why-variable-sequence-length-breaks-ddp-throughput/).
